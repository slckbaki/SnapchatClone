                                            ...
                                            let additionalDictionary = ["imageUrlArray" : imageUrlArray] as [String : Any]
                                                ...
                                                fireStore.collection("Snaps").document(documentId).setData(additionalDictionary, merge: true) { error in
                                                    if error == nil{
                                                        ...
                                                        self.makeAlert(title: "Photo Uploaded", message: "Thank you for using SnapchatClone")
                                                        let alert = UIAlertController(title: self.title, message: "Uploaded" , preferredStyle: UIAlertController.Style.alert)
